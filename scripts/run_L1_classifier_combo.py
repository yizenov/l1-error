...
# screen -S l1_classify -dm -L -Logfile scr_l1_classify.0 sh -c 'time /usr/bin/python3 scripts/run_L1_classifier_combo.py 0 0 0'

print(
"\n \
1. Enter: ~/L1_error_indicator\n \
2. Run the following command: /usr/bin/python3 scripts/run_L1_classifier_combo.py arg1 arg2 arg3\n \
    ...
    try:
        ...
        with open(file_name_prefixes, "r") as input_f:
            for idx, line in enumerate(input_f):
                ...
                # NOTE: feature data
                initial_all_data.append([query, weighted_sum_norm_L1, max_q_error, label]) 

        pd.set_option('display.max_rows', 500)
        column_names = ["query", "L1-error", "Q-error", "label"]
