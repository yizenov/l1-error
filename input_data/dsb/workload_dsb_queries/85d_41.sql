...
FROM web_sales AS ws,
   ...
   reason AS r
WHERE d.d_year = 1999
   AND ca.ca_country = 'United States' and ca.ca_state in ('AL', 'FL', 'KS')
   AND cd1.cd_marital_status = 'M' and cd1.cd_education_status = 'Advanced Degree'
   AND ws.ws_sales_price between 100.00 and 150.00 and ws.ws_net_profit between 150 and 300
