...
WHERE i.i_category in ('Books', 'Children', 'Electronics')
   AND ca.ca_state in ('CT', 'IL', 'MO', 'OH', 'VA')
   AND hd.hd_buy_potential = 'Unknown' and hd.hd_income_band_sk between 2 and 8
