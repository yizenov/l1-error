...
FROM web_sales AS ws,
   ...
   reason AS r
WHERE d.d_year = 1998
   AND ca.ca_country = 'United States' and ca.ca_state in ('MO', 'NJ', 'NM')
   AND cd1.cd_marital_status = 'D' and cd1.cd_education_status = 'Advanced Degree'
   AND ws.ws_sales_price between 150.00 and 200.00 and ws.ws_net_profit between 100 and 200
