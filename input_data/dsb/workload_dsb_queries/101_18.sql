...
WHERE i.i_category in ('Children', 'Home', 'Jewelry')
   AND ca.ca_state in ('AK', 'CA', 'MO', 'NM', 'NY')
   AND hd.hd_buy_potential = '501-1000' and hd.hd_income_band_sk between 6 and 12
