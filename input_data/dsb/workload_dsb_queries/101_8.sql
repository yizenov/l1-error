...
WHERE i.i_category in ('Children', 'Home', 'Shoes')
   AND ca.ca_state in ('KS', 'NC', 'OR', 'TX', 'VA')
   AND hd.hd_buy_potential = '5001-10000' and hd.hd_income_band_sk between 6 and 12
